---
slug: tcpa-compliance-lead-buyers
seo_title: "TCPA Compliance for Lead Buyers: The Complete Guide (2026)"
meta_description: "Everything lead buyers need to know about TCPA compliance in 2026. FCC 1:1 consent rules, auto-dialer restrictions, text message rules, DNC requirements, and penalties."
excerpt: "The complete TCPA compliance guide for agents and sales teams buying leads — 1:1 consent requirements, auto-dialer rules, text message compliance, DNC scrubbing, state mini-TCPA laws, and how to protect yourself from lawsuits."
category: blog
---

# TCPA Compliance for Lead Buyers: The Complete Guide (2026)
...
Here is the good news: TCPA compliance is not complicated once you understand the rules. And if you are [buying aged leads](/buying-leads/buy-aged-leads), you are actually in a better position than most — because the consent was already captured at the point of original opt-in. The risk comes from how you contact those leads, not whether they exist.
...
| Violation Type | Penalty Per Violation | Willful/Knowing Penalty | Notes |
|---|---|---|---|
| Calls using auto-dialer without consent | $500 | $1,500 | Per call or text |
| Pre-recorded/artificial voice without consent | $500 | $1,500 | Per call |
| National DNC list violation | Up to $43,792 | Up to $43,792 | FCC enforcement action |
| Internal DNC list violation | $500 | $1,500 | Per call |
...
If you are working a [follow-up cadence](/blog/aged-lead-follow-up-cadence) and a prospect says "stop calling," you have 10 business days to suppress that number across every system — your dialer, CRM, text platform, and skip-tracing tools. Miss one system and that next automated text becomes a $500-$1,500 violation. Build your suppression workflow now.
...
| Dialer Type | Federal ATDS? | Pre-Recorded Voice Rules Apply? | DNC Rules Apply? |
|---|---|---|---|
| Manual dial (click-to-call from CRM) | No | Yes, if using voicemail drops | Yes |
| Power dialer (sequential from list) | Likely No (post-Duguid) | Yes | Yes |
| Predictive dialer (list-based) | Likely No (post-Duguid) | Yes | Yes |
| Preview dialer | No | Yes, if using voicemail drops | Yes |
| Random/sequential number generator | Yes | Yes | Yes |
...
For lead buyers working [purchased lead lists](/buying-leads), the EBR exception rarely applies because you do not have a prior relationship with those consumers. Scrub every list, every time.
...
| State | Law | ATDS Definition | Calling Hours | Key Penalties | Notable Requirements |
|---|---|---|---|---|---|
| **Florida** | FTSA (2021, amended 2023) | Selection AND dialing (narrowed in 2023) | 8 AM - 8 PM | $500/$1,500 per violation | 30-day pre-suit notice required; STOP + 15-day cure for texts |
| **California** | Various statutes | Broader than federal | 8 AM - 9 PM | $500/$1,500 per violation | Requires registration; restricts auto-dialers to cell phones broadly |
| **New York** | Telemarketing Act | State definition | 8 AM - 9 PM | Up to $20,000 per violation (DNC) | Must offer DNC opt-out at start of call; S4617 increased fines |
| **Texas** | TCPA + SB 140 (Sept 2025) | Expanded to include texts and images | 8 AM - 9 PM | Treble damages via DTPA | Registration required; $200 fee + $10,000 security bond; covers SMS |
| **Washington** | RCW 80.36 + HB 1051 | Expanded definition | 8 AM - 9 PM | $500-$1,000 per violation | Registration + bonding required for commercial solicitors |
| **Oklahoma** | OTSA (HB 3168) | Broad definition | Restricted hours | Up to $10,000 per violation | Registration required; caps call attempts; broad autodialer scope |
| **Georgia** | SB 73 (2024) | State definition | 8 AM - 9 PM | No damage cap; vicarious liability | Eliminates "knowing" requirement; vicarious liability for employers |
| **Virginia** | SB 1339 (Jan 2026) | Federal alignment | 8 AM - 9 PM | Standard statutory damages | Must honor text opt-outs for 10 years |
...
If you are working [aged leads](/buying-leads/buy-aged-leads), you have a compliance advantage that fresh lead buyers do not — but it is not absolute.
...
| Lead Age | Phone Call Risk | Text Message Risk | Recommended Approach |
|---|---|---|---|
| 30-60 days | Low | Low-Medium | Standard outreach with context reminder |
| 60-90 days | Low-Medium | Medium | Re-establish context early in call; be cautious with automated texts |
| 90-180 days | Medium | Medium-High | Manual dial preferred; consider email/direct mail first contact |
| 180+ days | Medium-High | High | Email or direct mail first; phone follow-up after re-engagement signal |
...
For more on evaluating lead vendors, see our [buying leads guide](/buying-leads).
...
For a downloadable version of this checklist, visit our [compliance checklist tool](/tools/compliance-checklist).
