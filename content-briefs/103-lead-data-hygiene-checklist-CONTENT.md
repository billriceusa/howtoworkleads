# The Complete Lead-Data Hygiene Checklist for Agents Who Buy Leads (2026)

> **Sanity CMS Fields**
> - **Slug:** `lead-data-hygiene-checklist`
> - **SEO Title:** `Lead-Data Hygiene Checklist for Agents Who Buy Leads (2026)`
> - **Meta Description:** `Before you dial a purchased lead list, clean it. A 5-layer data-hygiene workflow — DNC, litigator, disconnected, landline, and internal opt-out scrubbing — to dial safer and waste fewer calls.`
> - **Excerpt:** `You bought the list. Now clean it before you dial. This is the five-layer hygiene workflow — DNC scrub, litigator scrub, disconnected-number removal, landline split, and internal opt-out suppression — that makes working purchased leads both safer and more productive.`
> - **Category:** Resources
...
1. **Internal opt-out scrub first** — remove anyone who's already told you to stop.
2. **Federal DNC scrub** — clean against the national registry (within the last 31 days).
3. **State DNC scrub** — clean against every state where you'll dial, honoring each state's rules.
4. **Litigator scrub** — suppress known serial TCPA plaintiffs.
5. **Validation pass** — drop disconnected, invalid, and unassigned numbers.
6. **Reassigned-number check** — flag numbers that may have changed hands.
7. **Line-type tag** — label wireless vs. landline vs. VoIP for smart routing.
8. **Document it** — save the date, the source, and the scrub results for every batch. If anyone ever asks, your records are your defense.
9. **Manual dial only** — work the clean file by hand or click-to-dial; no autodialer, predictive dialer, prerecorded voice, or ringless voicemail on non-consent data.
10. **Re-scrub on the clock** — anything older than 31 days gets cleaned again before the next session.
...
### Do I need to scrub against both federal and state Do-Not-Call lists?
...
### If my scrubbing vendor cleans the list, am I still liable?
...
### What is a TCPA litigator scrub, and do I really need one?
...
### How do I remove landlines and disconnected numbers before I dial?
...
### Is the FCC's one-to-one consent rule something I need to comply with?
...
Start the habit on your next batch. If you're shopping for clean inventory to begin with, you can browse and filter aged leads by type, age, and state over at [AgedLeadStore](https://www.agedleadstore.com/?ref=howtoworkleads) — then run everything you buy through the five layers above before the first dial. And for the legal backbone behind the workflow, work through the compliance library in [Resources](/resources): the [TCPA Compliance Guide for Lead Buyers](/tcpa-compliance-lead-buyers), [DNC Compliance for Aged Leads](/aged-leads-dnc-compliance), and the [State-by-State Lead Compliance Guide](/state-by-state-lead-compliance-guide). Clean the file, work it like the people on it matter, and let your dialer spend its time on numbers that can actually become customers.
