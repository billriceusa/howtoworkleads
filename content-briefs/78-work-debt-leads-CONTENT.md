...
> **Sanity CMS Fields**
> - **Slug:** `how-to-work-debt-leads`
> - **SEO Title:** `How to Work Debt Leads: Converting Consumers Who Need Financial Relief (2026)`
> - **Meta Description:** `Learn how to work debt leads with empathetic scripts, qualification frameworks, and follow-up cadences. Covers debt settlement, consolidation, credit counseling, and compliance.`
> - **Excerpt:** `Debt leads represent consumers in real financial distress — and they convert best when you lead with empathy, qualify fast, and follow up persistently. This is the complete playbook for working debt settlement, consolidation, and credit counseling leads.`
...
| Source | Typical Cost (Shared) | Typical Cost (Exclusive) | Contact Rate | Quality | Competition |
|--------|----------------------|--------------------------|--------------|---------|-------------|
| Google Ads (search intent) | $25–$50 | $75–$150 | 35–50% | High | Medium |
| Facebook/Instagram ads | $15–$35 | $50–$100 | 25–40% | Medium | Medium |
| Comparison/aggregator sites (LendingTree, Bankrate, etc.) | $20–$40 | $60–$120 | 30–45% | Medium–High | High |
| Lead gen companies (specialized) | $15–$35 | $50–$100 | 25–40% | Varies | High (shared) |
| Credit monitoring services | $20–$45 | $60–$130 | 30–45% | High | Medium |
| Direct mail response | $30–$60 | $80–$150 | 40–55% | High | Low |
| SEO/organic content | Cost of content creation | N/A | 40–60% | Very high | None |
...
[Speed to lead](/blog/speed-to-lead-aged-leads) isn't just a metric in debt relief — it's the difference between connecting with someone who's emotionally ready to act and leaving a voicemail for someone who's already closed the door.
...
This script works because it's true — [financial situations evolve](/blog/how-to-work-aged-insurance-leads), and the passage of time often makes debt worse, not better. Someone who wasn't ready 60 days ago might be desperate today after another missed payment, another collection call, or another late fee.
...
|-----|--------|---------|--------------|
| Day 0 (within 3 min) | Call | Phone | Empathetic, permission-based |
| Day 0 (within 15 min) | Text introduction | SMS | Soft, non-threatening |
| Day 0 (within 1 hour) | Email with overview | Email | Educational, no hard sell |
| Day 1 | Call (different time of day) | Phone | Brief, checking in |
| Day 2 | Text with helpful resource | SMS | Value-add content |
| Day 3 | Call + voicemail | Phone | Emphasize free consultation |
| Day 5 | Email with client success story | Email | Social proof, hope |
| Day 7 | Call + text | Phone, SMS | "Still here when you're ready" |
| Day 10 | Email with industry info | Email | Educational |
| Day 14 | Final attempt call | Phone | No pressure close |

### Aged Debt Lead Cadence

| Day | Action | Channel | Message Tone |
|-----|--------|---------|--------------|
| Day 1 | Call + text | Phone, SMS | Reconnection, situation check |
| Day 3 | Email with updated options | Email | "Things may have changed" |
| Day 5 | Call (different time) | Phone | Brief, empathetic |
| Day 8 | Text check-in | SMS | Light touch |
| Day 12 | Email with educational content | Email | Value-add |
| Day 18 | Call + voicemail | Phone | New information angle |
| Day 25 | Text ("here when you're ready") | SMS | No pressure |
| Day 30+ | Monthly nurture email | Email | Helpful, ongoing |

**Critical rule:** If a consumer asks you to stop contacting them, stop immediately. Document the request in your [CRM](/blog/best-crm-aged-leads) and remove them from all sequences. This isn't just good practice — it's legally required.
...
| Lead Age | Shared Cost | Exclusive Cost | Expected Contact Rate | Expected Enrollment |
|----------|-------------|----------------|-----------------------|--------------------|
| 0–7 days | $20–$50 | $60–$150 | 35–50% | 10–18% |
| 30–60 days | $8–$20 | $25–$60 | 20–32% | 6–10% |
| 60–120 days | $4–$12 | $15–$40 | 15–25% | 4–8% |
| 120–365 days | $2–$6 | $8–$25 | 10–18% | 3–5% |
...
The FTC's [Telemarketing Sales Rule](https://www.ftc.gov/legal-library/browse/rules/telemarketing-sales-rule) imposes specific requirements on debt relief companies:
...
For the latest guidance, review the [FTC's debt relief resources](https://www.ftc.gov/business-guidance/resources/debt-relief-services-consumer-protection-guide-businesses).
...
Many states have additional requirements for debt relief companies — licensing, bonding, fee caps, and specific disclosures. Check your [state compliance requirements](/blog/state-by-state-lead-compliance-guide) before operating in any new market.
...
Your [CRM](/blog/best-crm-aged-leads) needs to handle the emotional and regulatory complexity of debt leads. Here's the optimal setup:
...
The aged lead ROI is higher because the lower lead cost more than compensates for the lower contact and conversion rates. This is why sophisticated debt relief operations run a blend — fresh leads for volume and speed, [aged leads for margin](/blog/aged-leads-vs-fresh-leads).
...
Debt leads hide. They screen calls from unknown numbers. They delete emails from financial companies. A [multi-channel cadence](/blog/follow-up-cadence-aged-leads) — phone, text, email, even direct mail for high-value prospects — is the only way to break through the avoidance pattern.

### Compliance Shortcuts

In debt relief, compliance isn't a suggestion — it's survival. One FTC complaint investigated can cost more than your entire annual marketing budget. Build compliance into every workflow, record every disclosure, and document every consent. Review the [regulatory landscape](/blog/lead-buyer-regulatory-cheat-sheet) quarterly.
...
2. **Set up your CRM** with the custom fields and pipeline stages above. Build your [automation workflows](/blog/best-crm-aged-leads) before you buy a single lead.
...
5. **Buy 100–200 aged debt leads** at $5–$10 each from a [reputable vendor](/blog/how-to-evaluate-lead-vendor). This is your testing batch — you're calibrating scripts, measuring contact rates, and training your team.
6. **Work every lead through the full cadence.** Don't cherry-pick. The discipline of working every lead systematically is what separates professionals from amateurs.
7. **Track every metric:** contact rate, qualification rate, consultation rate, enrollment rate, cost per enrollment.

### Week 3–4: Optimize and Scale

8. **Analyze your data.** Which lead sources performed best? Which scripts got the highest qualification rate? Which follow-up touches generated callbacks?
9. **Add fresh leads** to your mix once your process is proven. Start with small volume and scale as your conversion rates stabilize.
10. **Build a [lead scoring system](/blog/ai-text-followup-aged-leads)** based on your data — prioritize leads with higher debt amounts, better contact rates, and stronger intent signals.

### Month 2+: Scale Systematically

11. **Hire or train additional agents** using your proven scripts and cadences. See our guide on [building a lead-based sales team](/blog/building-lead-based-sales-team).
12. **Diversify lead sources.** Don't depend on a single vendor or channel. Test Google, Facebook, aggregators, and direct mail.
13. **Implement quality assurance.** Listen to calls weekly. Score against your script and compliance checklist. The debt relief space has zero margin for error on compliance.
