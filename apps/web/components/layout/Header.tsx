...
const navigation = {
  categories: [
    ...
    },
    {
      ...
      href: '/crm-systems',
      articles: [
        { name: 'Using High Level or Close', href: '/crm-systems/highlevel-close-sales-system' },
      ],
    },
    {
      name: 'Buying Leads',
      href: '/buying-leads',
      articles: [
        { name: 'Buy Aged Leads', href: '/buying-leads/aged-leads' },
        { name: 'Buy Mortgage Leads', href: '/buying-leads/mortgage-leads' },
        { name: 'Buy Insurance Leads', href: '/buying-leads/insurance-leads' },
        { name: 'Buy Solar Leads', href: '/buying-leads/solar-leads' },
              ...
              >
                <Link
                  ...
                  className={cn(
                    ...
                    activeDropdown === category.name && 'text-primary-800'
                  )}
                >
                  {category.name}
                  <svg
