...
<body style="font-family: -apple-system, sans-serif; color: #1f2937; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(135deg, #0f172a, #1e40af); color: white; padding: 24px; border-radius: 12px; margin-bottom: 20px;">
    <h1 style="margin: 0 0 4px; font-size: 22px;">Newsletter Report</h1>
    <p style="margin: 0; opacity: 0.9; font-size: 14px;">How To Work Leads — Week of ${report.weekOf}</p>
  </div>
  ...
  <p style="color: #9ca3af; font-size: 11px;">Generated by the How To Work Leads newsletter cron job at ${report.runDate}</p>
</body></html>`;
}
