...
export async function sendWeeklyReport(
  ...
  const fromEmail =
    process.env.RESEND_FROM_EMAIL || "How To Work Leads <noreply@howtoworkleads.com>";
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; color: #1f2937; max-width: 800px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background: linear-gradient(135deg, #0f172a, #1e40af); color: white; padding: 24px 32px; border-radius: 12px; margin-bottom: 24px;">
    <h1 style="margin: 0 0 4px 0; font-size: 24px;">Weekly Content Report</h1>
    <p style="margin: 0; opacity: 0.9;">How To Work Leads — Week of ${report.weekStartDate}</p>
  ...
  <p style="color: #9ca3af; font-size: 12px;">This report was generated automatically by the How To Work Leads weekly content cron job.</p>
</body>
</html>`;
}
